...
<ProposalHeader status="aprovado" date="2026-07-28" />
...
_Proposta **aprovada** (28/07/2026). Implementação sequenciada: Custo real (#8 → #9/#10 → #15), depois Rateio (#16 → #17 → #21 → #18/#19 → #22)._
